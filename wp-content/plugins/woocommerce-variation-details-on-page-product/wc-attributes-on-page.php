...
Text Domain: woocommerce-variation-details-on-page-product
	...
	if ( ! class_exists( 'MP_WC_Variation_Details_On_Page_Product' ) ) {
		...
		class MP_WC_Variation_Details_On_Page_Product {
			...
			public function load_plugin_textdomain() {
				load_plugin_textdomain( 'woocommerce-variation-details-on-page-product', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
			}
