...
class MC4WP_Ecommerce_Command extends WP_CLI_Command  {
	...
	public function add_order( $args, $assoc_args = array() ) {
        ...
        try {
            ...
            WP_CLI::error( sprintf( "Error adding order %d: %s", $order_id, $e ) );
            return;
        }

        WP_CLI::success( sprintf( 'Success! Added order #%d.', $order_id ) );
	}
	...
	public function delete_order( $args, $assoc_args = array() ) {
        ...
        try {
            ...
            WP_CLI::error( sprintf( "Error deleting order %d: %s", $order_id, $e ) );
            return;
        }

        WP_CLI::success( sprintf( 'Success! Deleted order #%d.', $order_id ) );
	}
    ...
    public function add_product( $args, $assoc_args = array() ) {
        ...
        try {
            ...
            WP_CLI::error( sprintf( "Error adding product %d: %s", $product_id, $e ) );
            return;
        }
    ...
    public function delete_product( $args, $assoc_args = array() ) {
        ...
        try {
            ...
            WP_CLI::error( sprintf( "Error deleting product %d: %s", $product_id, $e ) );
            return;
        }
